...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 flex justify-center">
      <div
        className={`mt-2 mx-4 w-full max-w-6xl rounded-full transition-all duration-300 text-white ${
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className="md:hidden bg-white dark:bg-neutral-900 backdrop-blur-md shadow-md rounded-b-xl"
            >
